...
2. `context/architecture-context.md` — system structure, FSD layers, data model, and invariants
3. `context/ui-context.md` — theme, tokens, typography, layout, and component conventions
4. `context/code-standards.md` — TypeScript, FSD enforcement, tooling, and commands
